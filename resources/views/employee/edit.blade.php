<x-auth title="E Office | Edit Karyawan">
    <!-- Page Title -->
    <div class="row">
        <div class="col-12">
                            ...
                            <div class="tab-pane fade pt-3 show active" id="one" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{  old('nik') ??  $employees->nik}}" name="nik">
                                        @error('nik')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('phone') ?? $employees->phone}}" name="phone" placeholder="Masukan nomor handphone karyawan">
                                        @error('phone')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('ktp') ?? $employees->ktp}}" name="ktp" placeholder="Masukan nomor ktp karyawan">
                                        @error('ktp')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('ktp_address') ?? $employees->ktp_address}}" name="ktp_address" placeholder="Masukan alamat sesuai kpt karyawan">
                                        @error('ktp_address')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('city') ?? $employees->city}}" name="city" placeholder="Masukan domisili kota karyawan">
                                        @error('city')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('address') ?? $employees->address}}" name="address" placeholder="Masukan alamat karyawan">
                                        @error('address')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="tab-pane fade pt-3" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('place_of_birth') ?? $employees->place_of_birth }}" name="place_of_birth" placeholder="Masukan tempat lahir karyawan ( Opsional )">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="text-xs ml-1">Tanggal Lahir</label>
                                        <input type="date" class="field" value="{{ old('date_of_birth') ?? $employees->date_of_birth }}" name="date_of_birth">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="text-xs ml-1">Agama</label>
                                        <input type="text" class="field" value="{{ old('religion') ?? $employees->religion }}" name="religion" placeholder="Masukan agama karyawan ( Opsional )">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="text-xs ml-1">Jenis Kelamin</label>
                                        <select type="text" class="field" name="gender">
                                            @foreach ($genders as $key => $value)
                                                <option value="{{ $value }}" @if ($employees->gender === $value || old('gender') === $value) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select type="text" class="field" name="blood_group">
                                            @foreach ($bloodGroups as $key => $value)
                                                <option value="{{ $value }}" @if ($employees->blood_group === $value || old('bloodGroups') === $value) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select type="text" class="field" name="marital_status">
                                            @foreach ($maritalStatus as $key => $value)
                                                <option value="{{ $value }}" @if ($employees->marital_status === $value || old('maritalStatus') === $value) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade pt-3" id="three" role="tabpanel" aria-labelledby="three-tab">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select type="text" class="field" name="job_level">
                                            ...
                                            @foreach ($jobLevels as $jobLevel)
                                                <option value="{{ $jobLevel->id }}" @if ($employees->job_level_id === $jobLevel->id || old('job_level_id') === $jobLevel->id) selected @endif>{{ $jobLevel->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('job_level')
                                            <p class="invalid">{{ $message }}</p>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('name') ?? $employees->user->name}}" name="name" placeholder="Masukan nama karyawan">
                                        @error('phone')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="field" value="{{ old('email') ?? $employees->user->email}}" name="email" placeholder="Masukan email karyawan">
                                        @error('phone')
                                            <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
