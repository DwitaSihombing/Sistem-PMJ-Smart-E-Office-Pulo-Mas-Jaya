<x-auth title="E Office | Edit Surat Masuk">
    <!-- Page Title -->
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('incoming-mails.update', ['id' => $letter->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="field" name="sender_name" placeholder="Masukan nama pengirim" value="{{$letter->sender_name}}">
                                @error('sender_name')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="field" name="regarding" placeholder="Masukan perihal surat" value="{{$letter->regarding}}">
                                @error('regarding')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="field" name="letter_number" placeholder="Masukan nomor surat" value="{{$letter->letter_number}}">
                                @error('letter_number')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="field" name="date_of_letter" placeholder="Masukan tanggal surat" value="{{$letter->date_of_letter}}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="field" name="date_of_entry" placeholder="Masukan tanggal masuk" value="{{$letter->date_of_entry}}">
                                @error('date_of_entry')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
