    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                @unlessrole('director|department')
                    <form class="d-flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-action flex justify-center items-center gap-3">
                                                @role('director|department|sexy|division')
                                                <a href="{{ route('incoming-mails.show', ['id' => $letter->id]) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                @else
                                                <a href="{{ route('incoming-mails.show', ['id' => $letter->id]) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                <a href="{{ route('incoming-mails.edit', ['id' => $letter->id]) }}" class="action-icon"> <i class="mdi mdi-pen"></i></a>
