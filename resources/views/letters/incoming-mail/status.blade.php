    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Edit Status Surat Masuk</h4>
            </div>
        </div>
    </div>
    <!-- /Page Title -->
        ...
        <div class="row w-full xl:w-[800px]">
            <div class="col-12">
                <div class="card h-[calc(100%-1.5rem)]">
                    <form action="{{ route('incoming-mails.ubah', ['id' => $letter->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                    <div class="card-body">
                        ...
                        <table class="table table-centered text-xs mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-semibold whiztespace-nowrap">Nomor Surat</td>
