                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-action flex justify-center items-center gap-3">
                                                ...
                                                @else
                                                <a href="{{ route('memos.show', ['id' => $letter->id]) }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                <a href="{{ route('memos.edit', ['id' => $letter->id]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                <a href="{{ route('memos.editstatus', ['id' => $letter->id]) }}" class="action-icon"> <i class="mdi mdi-check"></i></a>
