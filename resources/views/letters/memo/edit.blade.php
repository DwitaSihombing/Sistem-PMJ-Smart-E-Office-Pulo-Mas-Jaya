<x-auth title="E Office | Tambah E-Memo">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('memos.update', ['id' => $letter->id]) }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="text-xs ml-1">Tanggal Surat</label>
                                <input type="date" class="field" name="date_of_letter" value="{{ $letter->date_of_letter }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="field" name="regarding" placeholder="Masukan perihal surat" value="{{$letter->creator->user->name}}">
                                @error('regarding')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="message" id="editor" value="{{ $letter->date_of_letter }}"></textarea>
                                @error('message')
                                    <p class="invalid">{{ $message }}</p>
                                @enderror
                            </div>
