<x-auth title="E Office | Edit Surat Keluar">
    <!-- Page Title -->
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('outgoing-mails.update', ['id' => $letter->id]) }}" method="POST">
                        @csrf
                        @method('put')
                            ...
                            <div class="tab-pane fade pt-3 show active" id="one" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="field bg-gray-100" value="{{$letter->date_of_letter}}" readonly name="date_of_letter">
                            ...
                            <div class="tab-pane fade pt-3" id="two" role="tabpanel" aria-labelledby="two-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="field bg-gray-100" readonly placeholder="" name="letter_number" value="{{$letter->letter_number}}">
                                        @error('letter_number')
                                        <p class="invalid">{{ $message }}</p>
                                        @enderror
                                    </div>
