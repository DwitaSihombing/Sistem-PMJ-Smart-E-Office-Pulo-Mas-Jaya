...
class OutgoingMailController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('letters.outgoing-mail.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('outgoing-mails')->with('success', 'Edit surat keluar berhasil.');
    }
    ...
    public function status($id)
    {
        ...
        return view('letters.outgoing-mail.status', $data);
    }
