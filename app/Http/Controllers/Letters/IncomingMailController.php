...
class IncomingMailController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('letters.incoming-mail.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $letter->letter_number = $request->letter_type;
        $letter->sender_name = $request->sender_name;
        $letter->regarding = $request->regarding;
        $letter->letter_number = $request->letter_number;
        $letter->date_of_letter = $request->date_of_letter;
        $letter->date_of_entry = $request->date_of_entry;
        $destination = Employee::with('user')->find($request->input('destination'));
        $letter->destination()->associate($destination);
        $letter->save();

        return redirect()->route('incoming-mails')->with('success', 'Edit surat masuk berhasil.');
    ...
    public function status($id)
    {
        ...
        return view('letters.incoming-mail.status', $data);
    }
