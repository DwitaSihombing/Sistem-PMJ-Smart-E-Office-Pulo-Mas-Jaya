...
class MemoController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('letters.memo.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('memos')->with('success', 'Berhasil mengedit e-memo.');
    }
    ...
    public function editstatus($id)
    {
        ...
        return view('letters.memo.editstatus', $data);
    }
    ...
    public function updatestatus(Request $request, $id)
    {
        ...
        return redirect()->route('memos')->with('success', 'Berhasil mengedit status e-memo.');
    }
