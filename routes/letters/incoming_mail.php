...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/incoming-mails/status/{id}', [IncomingMailController::class, 'status'])->name('incoming-mails.status');
    Route::put('/incoming-mails/ubah/{id}', [IncomingMailController::class, 'ubah'])->name('incoming-mails.ubah');
