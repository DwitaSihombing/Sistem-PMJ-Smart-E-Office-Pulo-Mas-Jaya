...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/memos/editstatus/{id}', [MemoController::class, 'editstatus'])->name('memos.editstatus');

    Route::put('/memos/updatestatus/{id}', [MemoController::class, 'updatestatus'])->name('memos.updatestatus');
