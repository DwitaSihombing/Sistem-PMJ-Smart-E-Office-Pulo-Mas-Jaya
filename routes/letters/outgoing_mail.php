...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/outgoing-mails/status/{id}', [OutgoingMailController::class, 'status'])->name('outgoing-mails.status');
    Route::put('/outgoing-mails/ubah/{id}', [OutgoingMailController::class, 'ubah'])->name('outgoing-mails.ubah');
